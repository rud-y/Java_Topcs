...
public class Student {
  ...
  private final Map<String, CourseEngagement> studentEngagementMap = new HashMap<>();
  ...
  public void addCourse(Course newCourse, LocalDate enrollDate) {
    studentEngagementMap.put(newCourse.courseCode(),
  ...
  public Map<String, CourseEngagement> getStudentEngagementMap() {
    return Map.copyOf(studentEngagementMap);
  }
  ...
  public double getPercentComplete(String courseCode) {
    var info = studentEngagementMap.get(courseCode);
  ...
  public void watchLecture(String courseCode, int lectureNumber, int month, int year) {
    var activity = studentEngagementMap.get(courseCode);
    if (activity != null) {
  ...
  public String toString() {
    return "Student{" +
            ...
            ", studentEngagementMap=" + studentEngagementMap +
            '}';
  }
}
